...
powershell "Get-CimInstance Win32_Processor | Select Name" >> report.log

echo "" >> report.log
echo "RAM:" >> report.log
powershell "Get-CimInstance Win32_PhysicalMemory | Select Capacity" >> report.log

echo "" >> report.log
echo "Anakart:" >> report.log
powershell "Get-CimInstance Win32_BaseBoard | Select Product" >> report.log

echo "" >> report.log
echo "UUID:" >> report.log
powershell "Get-CimInstance Win32_ComputerSystemProduct | Select UUID" >> report.log

echo "" >> report.log
echo "Disk:" >> report.log
powershell "Get-CimInstance Win32_DiskDrive | Select SerialNumber" >> report.log
